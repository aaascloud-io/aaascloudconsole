...
@Component({
    selector: 'ifcs-input-group',
    templateUrl: './ifcs-input-group.component.html',
    styleUrls: ['./ifcs-input-group.component.css']
})
export class IfcsInputGroupComponent implements OnInit {
