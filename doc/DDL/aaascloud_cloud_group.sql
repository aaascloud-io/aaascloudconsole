...
CREATE TABLE `cloud_group` (
  ...
  UNIQUE KEY `product_UNIQUE` (`projectId`,`groupName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='グループテーブル';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cloud_group`
--

LOCK TABLES `cloud_group` WRITE;
/*!40000 ALTER TABLE `cloud_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `cloud_group` ENABLE KEYS */;
UNLOCK TABLES;
